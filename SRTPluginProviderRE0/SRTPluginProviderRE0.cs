...
{
    public class SRTPluginProviderRE0 : IPluginProvider
    {
        private Process process;
        private GameMemoryRE0Scanner gameMemoryScanner;
        ...
        public int Startup(IPluginHostDelegates hostDelegates)
        {
            ...
            process = GetProcess();
            gameMemoryScanner = new GameMemoryRE0Scanner(process);
        ...
        private Process GetProcess() => Process.GetProcessesByName("re0hd")?.FirstOrDefault();
    }
}
